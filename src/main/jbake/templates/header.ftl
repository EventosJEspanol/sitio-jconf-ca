...
<html lang="en">
  <head>
    ...
    <title>JConf Central America 2020</title>
   ...
   <meta name="twitter:creator" content="@tuxtor">
    <meta name="twitter:image" content="http://guate-jug.net/jconf2020/img/post/<#if (content.img)??>${content.img}<#else>duke2020.jpg</#if>">
      <#if (content.summary)??>
      ...
      <meta property="og:image" content="http://guate-jug.net/jconf2020/img/post/<#if (content.img)??>${content.img}<#else>duke2020.jpg</#if>" />
      <#if (content.summary)??>
